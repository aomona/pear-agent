...
import { D1PlanRepository, PlanArtifactNotFoundError } from "../d1/plan-repository.js";
...
import { buildInitialExecutionState } from "./build-initial-state.js";

type SessionHono = Hono<{
  Bindings: PearEnv;
...
/**
 * Session CRUD / events / raw-input / normalized-input routes.
 */
